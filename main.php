...
<a href="<?=$a?>"> home </a>  <a href="<?=$a?>/product/one/"> one index </a>  <a href="https://trustedweb.herokuapp.com/product/one/one.php"> one.php </a>  <a href="<?=$a?>/product/two/"> two index </a> <a href="<?=$a?>/product/two/two.php"> two.php </a>  
